...
namespace TaleWorlds.Core
{
  public class WeaponComponentData
  {
      ...
      short reloadPhaseCount)
    {
      ...
      this.TotalInertia = inertia * (this.IsConsumable ? (float) maxDataValue : 1f);
    ...
    {
      get => this.WeaponFlags.HasAllFlags<WeaponFlags>(WeaponFlags.RangedWeapon);
    }
    ...
    public bool IsPolearm
    {
      get
      {
        return this.WeaponFlags.HasAllFlags<WeaponFlags>(WeaponFlags.MeleeWeapon | WeaponFlags.WideGrip);
      }
    }
    ...
    public bool IsAmmo
    {
      get => !this.WeaponFlags.HasAnyFlag<WeaponFlags>(WeaponFlags.WeaponMask) && this.IsConsumable;
    }
    ...
    public bool IsTwoHanded
    {
      get
      {
        return this.WeaponFlags.HasAllFlags<WeaponFlags>(WeaponFlags.MeleeWeapon | WeaponFlags.NotUsableWithOneHand);
      }
    }

    public bool IsOneHanded
    {
      get => this.WeaponFlags.HasAnyFlag<WeaponFlags>(WeaponFlags.MeleeWeapon) && !this.IsTwoHanded;
    }
    ...
    public bool IsBow
    {
      get
      {
        return this.WeaponFlags.HasAllFlags<WeaponFlags>(WeaponFlags.StringHeldByHand | WeaponFlags.AutoReload);
      }
    }

    public bool IsCrossBow
    {
      get => this.WeaponFlags.HasAnyFlag<WeaponFlags>(WeaponFlags.HasString) && !this.IsBow;
    }
    ...
    {
      get => WeaponComponentData.GetRelevantSkillFromWeaponClass(this.WeaponClass);
    }
    ...
    {
      SkillObject skillFromWeaponClass = (SkillObject) null;
      switch (weaponClass)
      {
        ...
        case WeaponClass.Mace:
          skillFromWeaponClass = DefaultSkills.OneHanded;
          break;
        case WeaponClass.TwoHandedSword:
        case WeaponClass.TwoHandedAxe:
        case WeaponClass.TwoHandedMace:
          skillFromWeaponClass = DefaultSkills.TwoHanded;
          break;
        case WeaponClass.OneHandedPolearm:
        case WeaponClass.TwoHandedPolearm:
        case WeaponClass.LowGripPolearm:
          skillFromWeaponClass = DefaultSkills.Polearm;
          break;
        case WeaponClass.Arrow:
        case WeaponClass.Bow:
          skillFromWeaponClass = DefaultSkills.Bow;
          break;
        case WeaponClass.Bolt:
        case WeaponClass.Crossbow:
          skillFromWeaponClass = DefaultSkills.Crossbow;
          break;
        ...
        case WeaponClass.BallistaStone:
          skillFromWeaponClass = DefaultSkills.Throwing;
          break;
    ...
    public void Deserialize(ItemObject item, XmlNode node)
    {
      ...
      this.ReloadPhaseCount = node.Attributes["reload_phase_count"] != null ? short.Parse(node.Attributes["reload_phase_count"].Value) : (short) 1;
      this.CenterOfMass = (float) ((double) this.WeaponLength * 0.5 * 0.0099999997764825821);
      ...
      if (attribute5 != null)
      {
        ...
        if (strArray.Length == 3)
        {
          ...
          rot1.RotateAboutSide(result1.ToRadians());
          rot1.RotateAboutUp(result2.ToRadians());
          rot1.RotateAboutForward(result3.ToRadians());
        }
      }
      vec3 = rot1.TransformToParent(in vec3);
      this.StickingFrame = new MatrixFrame(in rot1, in vec3);
      Vec3 o = new Vec3();
      ...
      if (attribute7 != null)
      {
        ...
        {
          float result4;
          float.TryParse(strArray[0], out result4);
          float result5;
          float.TryParse(strArray[1], out result5);
          float result6;
          float.TryParse(strArray[2], out result6);
          rot2.RotateAboutUp(result6.ToRadians());
          rot2.RotateAboutSide(result4.ToRadians());
          rot2.RotateAboutForward(result5.ToRadians());
        }
      }
      this.Frame = new MatrixFrame(in rot2, in o);
      ...
      this.TotalInertia = (float) ((this.IsConsumable ? (double) this.MaxDataValue : 1.0) * (double) item.Weight * 0.05000000074505806);
    ...
    private void SetDamageFactors(float weight)
    {
      ...
      {
        float num1 = MathF.Sqrt(MathF.Sqrt(weight / ((float) this.WeaponLength * 0.01f)));
        float num2 = 0.0f;
    ...
    public MatrixFrame GetMissileStartingFrame()
    {
      ...
      else
      {
        ...
        if (this.WeaponClass == WeaponClass.ThrowingAxe)
          identity.rotation.RotateAboutUp(-1.57079637f);
